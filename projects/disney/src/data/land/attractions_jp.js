...
export default [
  ...
  },
  {
    ...
    text:
      '<div class="iconTag">ファストパス対象</div><p class="text0">トラムに乗って、フラッシュライトでゆかいなモンスターたちを見つけよう！</p><div class="definitionList"><div class="term">[タイプ]</div><div class="description">ライド、雨の日も安心、大きな音がする、暗やみをすすむ、回転する</div><div class="term">[対象]</div><div class="description">補助なしで座れることが必要、身長制限なし</div><div class="term">提供：Panasonic</div><div class="description"></div></div>'
  }
];
