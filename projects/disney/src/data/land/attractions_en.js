export default [
  ...
  },
  {
    ...
    text:
      '<div class="iconTag">FASTPASS Attraction</div><p class="text0">Board a tram and search for the funny monsters.</p><div class="definitionList"><div class="term">[Type]</div><div class="description">Ride、OK on rainy days、Loud sounds、Go through darkness、Rotates / Spins</div><div class="term">[Appropriate for]</div><div class="description">Must be able to sit without assistance、No height restrictions</div><div class="term">Presented by Panasonic</div><div class="description"></div></div>'
  }
];
